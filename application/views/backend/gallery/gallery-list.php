            ...
            <div class="table-responsive">
                <table class="data-table table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td><img src="<?php echo base_url() . $row->gallery_img; ?>" class="table-card" alt="Gallery Image"></td>
                            ...
                            <td>
                                ...
                                <?php } elseif($row->status == 'inactive') { ?>
                                    <a href="javascript:void(0);" data-value="active" dazta-rowid="<?php echo $row->id; ?>" data-tablename="gallery" data-link="<?php echo base_url(); ?>admin/gallery/gallery-list" class="text-danger changeStatus" data-toggle="tooltip" data-placement="top" title="Status Change"> Inactive </a>
                                <?php } ?>
                            </td>
                            <td><?php $dateFormat = new DateTime($row->created_at); echo $dateFormat->format('d-m-Y h:i A'); ?></td>
                            <td class="px-2">
                                <div class="d-flex gap-1 justify-content-center">
                                    <a href="<?php echo base_url() . 'admin/gallery/gallery-view/' . $row->id; ?>" class="box-hover" data-toggle="tooltip" data-placement="top" title="View"> <i class="bx bx-show-alt"></i> </a>
